...
@interface EditSignViewController : UITableViewController <UIPickerViewDataSource, UIPickerViewDelegate, UIActionSheetDelegate>
...
@property (strong,nonatomic) NSString *suggestionTrigger;
